...
class FilterViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        //thisFeedItem.cdate = FeedViewController.getCurrentTimeStamp()
    ...
    func cacheImage(imageNumber: Int) {
        ...
        let fileName = "EXG_\(self.thisFeedItem.cdate)_\(imageNumber)"
        //let fileName = "\(imageNumber)-\(thisFeedItem.image.hashValue)"
       // let fileName = "\(imageNumber)\(thisFeedItem.image.length)"
        ...
        func getCachedImage (imageNumber: Int) -> UIImage {
            //let fileName = "\(imageNumber)"
           // println(self.thisFeedItem.cdate)
            let fileName = "EXG_\(self.thisFeedItem.cdate)_\(imageNumber)"
            //let fileName = "\(imageNumber)\(thisFeedItem.image.length)"
            //let fileName = "\(imageNumber)-\(thisFeedItem.image.hashValue)"
            let uniquePath = tmp.stringByAppendingPathComponent(fileName)
